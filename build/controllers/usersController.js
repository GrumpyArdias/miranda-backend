...
const createUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = Object.assign(Object.assign({}, newUser), { id: (0, uuid_1.v4)(), fullName: newUser.fullName, email: newUser.email, joinDate: newUser.joinDate, description: newUser.description, status: newUser.status, number: newUser.number });
